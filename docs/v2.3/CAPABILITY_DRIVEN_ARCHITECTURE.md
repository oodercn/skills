...
| 协作关系 | 场景组是独立概念 | 协作能力是场景能力的一部分 | collaborativeCapabilities |

### 6.2 统一模型

```
场景能力 = SuperAgent = 自驱能力容器
