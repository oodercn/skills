...
@DriverImplementation(value = "DatabaseDriver", skillId = "skill-db-sqlite")
    ...
    public void init(DatabaseConfig config) {
        ...
        try {
            ...
            if (url == null || url.isEmpty()) {
                url = "jdbc:sqlite:" + (config.getDatabase() != null ? config.getDatabase() : ":memory:");
            }
            ...
            connected = true;
            log.info("SQLite database initialized: {}", url);
