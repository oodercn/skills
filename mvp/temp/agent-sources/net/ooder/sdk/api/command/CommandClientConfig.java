...
public class CommandClientConfig {
    ...
    public CommandClientConfig(String clientId, String sceneId) {
        this.clientId = clientId;
        this.sceneId = sceneId;
    }
    
    public static CommandClientConfig create(String clientId, String sceneId) {
        return new CommandClientConfig(clientId, sceneId);
    }
    ...
    public CommandClientConfig groupId(String groupId) {
        this.groupId = groupId;
        return this;
    }
    
    public CommandClientConfig domainId(String domainId) {
        this.domainId = domainId;
        return this;
    }
    
    public CommandClientConfig defaultTimeout(long timeout) {
