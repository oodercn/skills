package net.ooder.sdk.core.command.impl;
...
public class CommandClientProxyImpl implements CommandClientProxy {
    
    private static final Logger log = LoggerFactory.getLogger(CommandClientProxyImpl.class);
    
    private final String clientId;
    private final String sceneId;
    private final String groupId;
    
    private CommandClientConfig config;
    ...
    public CommandClientProxyImpl(String clientId, String sceneId) {
    ...
    @Override
    public void initialize(CommandClientConfig config) {
        this.config = config;
        log.info("CommandClientProxy initialized: {} for scene: {}", clientId, sceneId);
    }
    ...
    public void start() {
        if (running.compareAndSet(false, true)) {
            ...
            log.info("CommandClientProxy started: {}", clientId);
        }
    }
    ...
    public void stop() {
        if (running.compareAndSet(true, false)) {
            ...
            log.info("CommandClientProxy stopped: {}", clientId);
        }
    }
