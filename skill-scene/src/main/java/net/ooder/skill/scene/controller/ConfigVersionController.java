...
import net.ooder.skill.scene.config.ConfigVersion;
import net.ooder.skill.scene.config.ConfigVersionService;
import net.ooder.skill.scene.config.ConfigVersionService.ConfigDiff;
