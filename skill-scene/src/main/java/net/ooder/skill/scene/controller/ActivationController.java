...
import net.ooder.skill.scene.capability.activation.ActivationProcess;
import net.ooder.skill.scene.capability.activation.ActivationService;
import net.ooder.skill.scene.capability.activation.ActivationService.KeyResult;
