...
| 版本 | 发布日期 | 里程碑 |
|------|----------|--------|
| v2.2.0 | 2026-02-15 | 分类体系重构，17个分类 |
| v2.3.0 | 2026-03-01 | 新增 llm/knowledge 等8个分类 |
| v2.3.1 | 2026-03-18 | skill-index 拆分，移除单文件支持 |
| v3.0.1 | 2026-03-29 | 统一版本号，归档过程文档，三大 IM-CLI 集成 |
| v3.1.0 | 2026-04-15 | AI Agent 增强，支持多轮对话 |
