...
| 1.5 | 2026-03-02 | 新增零配置安装用户故事（场景模板部署、依赖自动安装、场景组创建、能力动态绑定） |
...
**作为** 用户  
**我想要** 从场景模板列表中选择一个模板并一键部署  
**以便于** 快速获得一个可用的业务场景

**验收标准**：
- [ ] 显示可用场景模板列表
- [ ] 每个模板显示名称、描述、包含的 Skills
- [ ] 点击"部署"按钮开始安装
- [ ] 自动检查并安装缺失的 Skills（含依赖）
- [ ] 显示安装进度和结果
- [ ] 安装完成后自动创建场景
...
**作为** 用户  
**我想要** 安装一个 Skill 时自动安装其所有依赖  
**以便于** 无需手动处理复杂的依赖关系

**验收标准**：
- [ ] 解析 skill.yaml 中的 dependencies
- [ ] 检查每个依赖是否已安装
- [ ] 未安装的依赖自动下载安装
- [ ] 递归处理子依赖
- [ ] 显示依赖安装结果（成功/跳过/失败）
