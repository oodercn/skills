...
public class UserServiceImpl implements UserService {
    ...
    public @ResponseBody ResultModel<User> login(@RequestBody User user) {
        ...
        try {
            boolean login = dingdingOrgManager.verifyPerson(user.getAccount(), user.getPassword());
            if (login) {
                net.ooder.org.Person person = dingdingOrgManager.getPersonByAccount(user.getAccount());
