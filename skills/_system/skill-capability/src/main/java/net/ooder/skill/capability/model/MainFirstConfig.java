...
public class MainFirstConfig implements Serializable {
    ...
    public List<CheckStep> getSelfCheck() { return selfCheck; }
    public void setSelfCheck(List<CheckStep> selfCheck) { this.selfCheck = selfCheck; }
    public List<StartStep> getSelfStart() { return selfStart; }
    public void setSelfStart(List<StartStep> selfStart) { this.selfStart = selfStart; }
    public DriveConfig getSelfDrive() { return selfDrive; }
    public void setSelfDrive(DriveConfig selfDrive) { this.selfDrive = selfDrive; }
    public List<CollaborationStep> getStartCollaboration() { return startCollaboration; }
    public void setStartCollaboration(List<CollaborationStep> startCollaboration) { this.startCollaboration = startCollaboration; }
    ...
    public static class CheckStep implements Serializable {
        ...
        public List<String> getCheckCapabilities() { return checkCapabilities; }
        public void setCheckCapabilities(List<String> checkCapabilities) { this.checkCapabilities = checkCapabilities; }
        public List<String> getCheckDriverCapabilities() { return checkDriverCapabilities; }
        public void setCheckDriverCapabilities(List<String> checkDriverCapabilities) { this.checkDriverCapabilities = checkDriverCapabilities; }
        public List<String> getCheckCollaborative() { return checkCollaborative; }
        public void setCheckCollaborative(List<String> checkCollaborative) { this.checkCollaborative = checkCollaborative; }
    }
    ...
    public static class StartStep implements Serializable {
        ...
        public List<String> getInitDriverCapabilities() { return initDriverCapabilities; }
        public void setInitDriverCapabilities(List<String> initDriverCapabilities) { this.initDriverCapabilities = initDriverCapabilities; }
        public List<String> getInitCapabilities() { return initCapabilities; }
        public void setInitCapabilities(List<String> initCapabilities) { this.initCapabilities = initCapabilities; }
        public String getBindAddresses() { return bindAddresses; }
        public void setBindAddresses(String bindAddresses) { this.bindAddresses = bindAddresses; }
    }
    ...
    public static class DriveConfig implements Serializable {
        ...
        public List<ScheduleRule> getScheduleRules() { return scheduleRules; }
        public void setScheduleRules(List<ScheduleRule> scheduleRules) { this.scheduleRules = scheduleRules; }
        public List<EventRule> getEventRules() { return eventRules; }
        public void setEventRules(List<EventRule> eventRules) { this.eventRules = eventRules; }
        public Map<String, CapabilityChain> getCapabilityChains() { return capabilityChains; }
        public void setCapabilityChains(Map<String, CapabilityChain> capabilityChains) { this.capabilityChains = capabilityChains; }
    }
    ...
    public static class CollaborationStep implements Serializable {
        ...
        public String getBindInterface() { return bindInterface; }
        public void setBindInterface(String bindInterface) { this.bindInterface = bindInterface; }
    }
