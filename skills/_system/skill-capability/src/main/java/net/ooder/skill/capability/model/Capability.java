...
public class Capability implements Serializable {
    ...
    public void setCapabilityType(CapabilityType capabilityType) { this.capabilityType = capabilityType; }
    ...
    public boolean supportsSceneType(String sceneType) { return supportedSceneTypes != null && supportedSceneTypes.contains(sceneType); }
    ...
    public void setCollaborativeCapabilities(List<CollaborativeCapabilityRef> collaborativeCapabilities) { this.collaborativeCapabilities = collaborativeCapabilities; }
    ...
    public boolean isSceneCapability() { return "SCENE".equals(skillForm) || capabilityType == CapabilityType.SCENE; }
    public void setSceneCapability(boolean sceneCapability) { this.skillForm = sceneCapability ? SkillForm.SCENE : SkillForm.PROVIDER; }
    ...
    public boolean isHasSelfDrive() { return mainFirst && hasSelfDriveConfig(); }
    private boolean hasSelfDriveConfig() { return mainFirstConfig != null && mainFirstConfig.getSelfDrive() != null; }
    private boolean hasTriggerConfig() { return driverType != null && driverType.isTrigger(); }
    public boolean isDriverCapability() { return capabilityType == CapabilityType.DRIVER; }
    public boolean isEnabled() { return status == CapabilityStatus.ENABLED || status == CapabilityStatus.REGISTERED; }
    public Map<String, Object> getConfig() { Map<String, Object> config = new HashMap<String, Object>(); if (metadata != null) { config.putAll(metadata); } return config; }
    public Map<String, Object> getMetadata() { Map<String, Object> result = new HashMap<String, Object>(); if (metadata != null) { result.putAll(metadata); } result.put("version", version); result.put("createTime", createTime); result.put("updateTime", updateTime); result.put("ownerId", ownerId); result.put("skillId", skillId); result.put("skillForm", skillForm); result.put("sceneType", sceneType); return result; }
    public void setMetadata(Map<String, Object> metadata) { this.metadata = metadata; }
    public String getIcon() { if (icon != null) { return icon; } return capabilityType != null ? capabilityType.getIcon() : "ri-flashlight-line"; }
    public void setIcon(String icon) { this.icon = icon; }
    public List<String> getDependencies() { if (dependencies != null) { return dependencies; } return capabilities; }
    public void setDependencies(List<String> dependencies) { this.dependencies = dependencies; }
    public List<String> getOptionalCapabilities() { if (optionalCapabilities != null) { return optionalCapabilities; } List<String> optional = new ArrayList<String>(); if (collaborativeCapabilities != null) { for (CollaborativeCapabilityRef ref : collaborativeCapabilities) { optional.add(ref.getCapabilityId()); } } return optional; }
    ...
    public SceneType getSceneTypeEnum() { return sceneType; }
    public String getSceneType() { return sceneType != null ? sceneType.getCode() : null; }
    public void setSceneType(SceneType sceneType) { this.sceneType = sceneType; }
    public void setSceneType(String sceneType) { this.sceneType = sceneType != null ? SceneType.fromCode(sceneType) : null; }
    public Visibility getVisibilityEnum() { return visibility; }
    public String getVisibility() { return visibility != null ? visibility.getCode() : null; }
    public void setVisibility(Visibility visibility) { this.visibility = visibility; }
    public void setVisibility(String visibility) { this.visibility = visibility != null ? Visibility.fromCode(visibility) : Visibility.PUBLIC; }
    ...
    public List<CapabilityAddress> getRequiredAddresses() { return requiredAddresses; }
    public void setRequiredAddresses(List<CapabilityAddress> requiredAddresses) { this.requiredAddresses = requiredAddresses; }
    public List<CapabilityAddress> getOptionalAddresses() { return optionalAddresses; }
    public void setOptionalAddresses(List<CapabilityAddress> optionalAddresses) { this.optionalAddresses = optionalAddresses; }
    public List<DriverCondition> getDriverConditions() { return driverConditions != null ? driverConditions : new ArrayList<DriverCondition>(); }
    public void setDriverConditions(List<DriverCondition> driverConditions) { this.driverConditions = driverConditions; }
    public List<Participant> getParticipants() { return participants != null ? participants : new ArrayList<Participant>(); }
    public void setParticipants(List<Participant> participants) { this.participants = participants; }
    public boolean isPublicVisible() { return visibility == Visibility.PUBLIC || visibility == Visibility.DEVELOPER; }
    public boolean isInternalVisible() { return visibility == Visibility.INTERNAL; }
    public boolean isDeveloperVisible() { return visibility == Visibility.DEVELOPER; }
    ...
    public CapabilityOwnership getOwnership() { if (parentSkill != null && parentScene != null) { return CapabilityOwnership.SCENE_INTERNAL; } else if (supportedSceneTypes != null && !supportedSceneTypes.isEmpty()) { return CapabilityOwnership.INDEPENDENT; } else { return CapabilityOwnership.PLATFORM; } }
    public boolean isSceneInternal() { return getOwnership() == CapabilityOwnership.SCENE_INTERNAL; }
    public boolean isIndependent() { return getOwnership() == CapabilityOwnership.INDEPENDENT; }
    public boolean isPlatform() { return getOwnership() == CapabilityOwnership.PLATFORM; }
    public void addSceneType(String sceneType) { if (supportedSceneTypes == null) { supportedSceneTypes = new ArrayList<String>(); } if (!supportedSceneTypes.contains(sceneType)) { supportedSceneTypes.add(sceneType); this.updateTime = System.currentTimeMillis(); } }
    public void removeSceneType(String sceneType) { if (supportedSceneTypes != null) { supportedSceneTypes.remove(sceneType); this.updateTime = System.currentTimeMillis(); } }
    ...
    public static class Participant implements Serializable {
        ...
        public Participant() { this.permissions = new ArrayList<String>(); }
    ...
    public static class ParameterDef implements Serializable {
        ...
        private String description;
        public ParameterDef() {}
        public ParameterDef(String name, String type, boolean required) { this.name = name; this.type = type; this.required = required; }
        public String getName() { return name; }
        public void setName(String name) { this.name = name; }
