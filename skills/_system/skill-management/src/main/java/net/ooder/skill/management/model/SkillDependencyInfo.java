...
public class SkillDependencyInfo implements Serializable {
    ...
    public static class SceneDependency implements Serializable {
    ...
    public static class ResourceDependency implements Serializable {
