...
public class MinioFileObject implements FileObject, Cacheable, Serializable {

    private static final long serialVersionUID = 5284347777800353507L;
    ...
    private FileAdapter getFileAdapter() {
        return MinioVfsConfig.getInstance().getFileAdapter();
    }
