...
public class S3FileObject implements FileObject, Cacheable, Serializable {

    private static final long serialVersionUID = 5284347777800353505L;
    ...
    private FileAdapter getFileAdapter() {
        return S3VfsConfig.getInstance().getFileAdapter();
    }
