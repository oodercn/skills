package net.ooder.skill.installer.controller;

import net.ooder.skill.installer.dto.InstallerStatusDTO;
import net.ooder.skill.installer.dto.InstallerStatusRequestDTO;
import net.ooder.skill.installer.model.ResultModel;
...
public class InstallerController {
    ...
    public ResultModel<InstallerStatusDTO> saveStatus(@RequestBody InstallerStatusRequestDTO request) {
        log.info("[InstallerController] saveStatus request: {}", request);
        ...
        try {
            ...
            log.error("[InstallerController] Failed to save status", e);
    ...
    public ResultModel<InstallerStatusDTO> getStatus() {
        log.info("[InstallerController] getStatus request");
        ...
        try {
            ...
            log.error("[InstallerController] Failed to get status", e);
    ...
    public ResultModel<InstallerStatusDTO> getLoopStatus(@PathVariable String loop) {
        log.info("[InstallerController] getLoopStatus loop: {}", loop);
        ...
        try {
            ...
            log.error("[InstallerController] Failed to get loop status", e);
            return ResultModel.error("Failed to get loop status: " + e.getMessage());
        }
    }
}