...
public class SelectorController {
    ...
    public ResultModel<List<Map<String, Object>>> getCapabilities(
        ...
        if (type != null && !type.isEmpty()) {
            capabilities = capabilityService.findByType(
                net.ooder.skill.scene.capability.model.CapabilityType.valueOf(type));
        } else {
    ...
    public ResultModel<List<Map<String, Object>>> getCapabilityTypes() {
        ...
        for (net.ooder.skill.scene.capability.model.CapabilityType type : 
                net.ooder.skill.scene.capability.model.CapabilityType.values()) {
    ...
    public ResultModel<List<Map<String, Object>>> getSceneGroups() {
        ...
        try {
            ...
            for (Object obj : groups) {
                ...
                } else if (obj instanceof net.ooder.skill.scene.dto.scene.SceneGroupDTO) {
                    net.ooder.skill.scene.dto.scene.SceneGroupDTO dto = 
                        (net.ooder.skill.scene.dto.scene.SceneGroupDTO) obj;
        ...
        try {
            ...
            for (Object obj : templates) {
                ...
                if (obj instanceof Map) {
                    ...
                    item.put("name", map.get("name"));
                    item.put("description", map.get("description"));
                } else if (obj instanceof net.ooder.skill.scene.dto.scene.SceneTemplateDTO) {
                    net.ooder.skill.scene.dto.scene.SceneTemplateDTO dto = 
                        (net.ooder.skill.scene.dto.scene.SceneTemplateDTO) obj;
