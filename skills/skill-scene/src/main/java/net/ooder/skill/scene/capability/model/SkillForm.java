...
public enum SkillForm implements DictItem {
    ...
    SCENE("SCENE", "场景技能", "容器型技能，可包含子技能", "ri-layout-grid-line", 1),
    PROVIDER("PROVIDER", "能力提供者", "提供基础能力的技能", "ri-cpu-line", 2),
    DRIVER("DRIVER", "驱动技能", "驱动场景运行的技能", "ri-steering-line", 3),
    INTERNAL("INTERNAL", "内部能力", "系统内部使用的技能", "ri-settings-3-line", 4);
