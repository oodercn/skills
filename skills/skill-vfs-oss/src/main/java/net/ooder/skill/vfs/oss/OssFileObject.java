...
public class OssFileObject implements FileObject, Cacheable, Serializable {

    private static final long serialVersionUID = 5284347777800353506L;
    ...
    private FileAdapter getFileAdapter() {
        return OssVfsConfig.getInstance().getFileAdapter();
    }
