 ...
 * @version 1.0
 */
public class DbActivityHistoryService implements Serializable {
	 ...
	 */
	public void copy(DbActivityHistoryService bean) {
	...
	public String toString() {
		return "\n[RT_ACTIVITYHISTORY_SERVICE] "
				...
				+ ""
				+ "\n - RT_ACTIVITYHISTORY_SERVICE.PERSON_ID = "
				+ (endPointId_is_initialized ? ("[" + endPointId.toString() + "]")
						: "not initialized")
				+ ""
				+ "\n - RT_ACTIVITYHISTORY_SERVICE.PERSONNAME = "
				+ (endPointName_is_initialized ? ("[" + endPointName.toString() + "]")
						: "not initialized")
				+ ""
				+ "\n - RT_ACTIVITYHISTORY_SERVICE.RIGHT_GRP_CODE = "
