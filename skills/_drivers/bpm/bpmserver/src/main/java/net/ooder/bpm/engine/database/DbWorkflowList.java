 ...
 * </p>
 * <p>
 * Description: 宸ヤ綔娴佸伐鍏风被锛屽疄鐜癹ava.util.List鎺ュ彛锛屽偍瀛樺悇涓璞＄殑UUID锛?褰撻渶瑕佺殑鏃跺€欐墠浠庢暟鎹腑鍙栧緱瀹為檯鐨勬暟鎹璞?
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public abstract class DbWorkflowList extends AbstractList implements Cloneable,
		Serializable {
	...
	public DbWorkflowList(Collection c) {
		...
		elementData = new Object[(int) Math.min((size * 110L) / 100,
				Integer.MAX_VALUE)];
	...
	public Object get(int index) {
		RangeCheck(index);
		prepareGet(index);
		return getWorkflowObject(elementData[index]);
	}
	...
	/**
	 * 鍑嗗璇诲彇鐩稿簲鐨勬暟鎹紝瀛愮被鍙互棰勫厛浠庢暟鎹腑璇诲彇鍚庨潰鐨勬暟鎹?br>
	 * 榛樿瀹炵幇涓嶅仛浠讳綍宸ヤ綔!
	 * 
	 * @param index
	 */
	...
	/**
	 * 灏哢UID杞负鐩稿簲鐨勫伐浣滄祦瀵硅薄
	 * 
	 * @param obj
	 * @return
	 */
	protected abstract Object getWorkflowObject(Object obj);
