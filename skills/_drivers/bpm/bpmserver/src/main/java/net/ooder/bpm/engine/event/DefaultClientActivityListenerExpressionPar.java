 ...
 * @version 2.0
 */
public class DefaultClientActivityListenerExpressionPar implements ActivityListener {
	...
	public void expressionPar(ActivityEvent event,String methodName){		
		...
		if (listener.getExpressionListenerType().equals(ListenerEnums.EXPRESSIONLISENTERTYPE_EXPRESSION) 
