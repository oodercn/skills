...
public class DbProcessInst implements EIProcessInst, Cacheable, Serializable {
	 ...
	 * 例如�?br>
	 * "Form1.field1.readRight" - 取得最顶层属性中名称为form1的下的名称为field1的子属性下名称为value的�?
	 * 
	 * @param name
	 *            属性名�?"."隔开，不区分大小�?
	 * @return 属性值，此值已经使用AttributeInterpret接口实现类解释后的�?
	 */
	 ...
	 * attribute map try { //执行数据库删除操�?( (DbProcessInstManager)
