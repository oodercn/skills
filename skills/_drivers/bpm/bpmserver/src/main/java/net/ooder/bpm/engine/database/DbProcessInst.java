 ...
 * </p>
 * <p>
 * Description: 娴佺▼瀹炰緥鎺ュ彛鐨勬暟鎹簱瀹炵幇
 * </p>
 * <p>
...
public class DbProcessInst implements EIProcessInst, Cacheable, Serializable {
	...
	/**
	 * 鍙栧緱鎵╁睍灞炴€у€硷紝姝ゅ€煎凡缁忕粡杩囪В閲婏紙鐩存帴鍙栧緱鐩稿簲娴佺▼瀹氫箟鐗堟湰鐨勬墿灞曞睘鎬у€硷級<br>
	...
	/**
	 * 鍙栧緱鎵╁睍灞炴€у€?姝ゅ€兼槸鏈粡瑙ｆ瀽鐨勫師鍊硷紝鍗虫暟鎹簱涓偍瀛樼殑鍊?br>
	 * 褰撻渶瑕佸彇寰楀甫灞傛鍏崇郴鐨勫睘鎬у€兼椂锛屽睘鎬у悕绉板湪姣忓眰闂村姞"."鍒嗗壊 <br>
	 * 渚嬪锛?br>
	 * "Form1.field1.readRight" - 鍙栧緱鏈€椤跺眰灞炴€т腑鍚嶇О涓篺orm1鐨勪笅鐨勫悕绉颁负field1鐨勫瓙灞炴€т笅鍚嶇О涓簐alue鐨勫€?
	 * 
	 ...
	 * attribute map try { //鎵ц鏁版嵁搴撳垹闄ゆ搷浣?( (DbProcessInstManager)
	 * EIProcessInstManager .getInstance()) .removeAttributeFromDb(
	 * (DbAttributeInst)attr); } catch (BPMException e) { //淇濆瓨澶辫触锛屽皢鏍囪缃负true
