...
public class NexusInitializerImpl implements NexusInitializer {
    ...
    public NexusInitializerImpl(SkillPackageManager skillPackageManager, SceneManager sceneManager) {
        ...
        this.sceneGroupLoader = new YamlSceneGroupLoader();
    }

    public void setSceneGroupLoader(SceneGroupLoader sceneGroupLoader) {
        this.sceneGroupLoader = sceneGroupLoader;
    }
    ...
    public CompletableFuture<List<SceneGroupInfo>> getAvailableSceneGroups() {
        return CompletableFuture.supplyAsync(() -> sceneGroupLoader.loadSceneGroups());
    }

    @Override
    public CompletableFuture<SceneGroupInfo> getSceneGroupInfo(String sceneGroupId) {
        return CompletableFuture.supplyAsync(() -> sceneGroupLoader.loadSceneGroup(sceneGroupId));
    }
