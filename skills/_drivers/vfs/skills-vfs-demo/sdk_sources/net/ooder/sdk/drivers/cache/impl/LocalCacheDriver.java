...
@DriverImplementation(value = "CacheDriver", skillId = "skill-cache-local")
public class LocalCacheDriver implements CacheDriver {
    
    private static final Logger log = LoggerFactory.getLogger(LocalCacheDriver.class);
