...
import net.ooder.sdk.api.command.BatchCommandResult;
import net.ooder.sdk.api.command.CommandTrace;
...
public interface ProtocolHub {
    ...
    default CompletableFuture<CommandResult> rollback(String commandId) {
        CommandResult result = CommandResult.failure("Rollback not supported for command: " + commandId);
    ...
    default CompletableFuture<CommandResult> retryCommand(String commandId) {
        CommandResult result = CommandResult.failure("Retry not supported for command: " + commandId);
        return CompletableFuture.completedFuture(result);
    }
