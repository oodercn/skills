package net.ooder.vfs.service.impl;
...
import net.ooder.config.ConnectInfo;
...
public class VFSClientImpl implements VFSClient {

    protected static Log log = LogFactory.getLog(OrgConstants.VFSCONFIG_KEY.getType(), VFSClientImpl.class);
