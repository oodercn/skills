...
public class DBFileObject implements FileObject, Cacheable, Serializable {
    private static final Log logger = LogFactory.getLog(OrgConstants.VFSCONFIG_KEY.getType(), DBFileObject.class);
    ...
    private FileAdapter getFileAdapter() {
        FileAdapter fileAdapter = OrgConfig.getInstance(subSystemId).getFileAdapter(getRootPath());
        return fileAdapter;
    ...
    public int getCachedSize() {
        ...
        size += CacheSizes.sizeOfObject(hash);
