...
public class DBFileCopy implements FileCopy {
    ...
    private ConfigCode subSystemId = ConfigCode.vfs;
    ...
    public ConfigCode getSubSystemId() { return subSystemId; }
    public void setSubSystemId(ConfigCode subSystemId) { this.subSystemId = subSystemId; }
    public void setMaxRight(int maxRight) { this.right = maxRight; }
    public int getMaxRight() { return this.right; }
