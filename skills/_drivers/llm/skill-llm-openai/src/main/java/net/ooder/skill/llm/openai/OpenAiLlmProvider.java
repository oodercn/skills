...
public class OpenAiLlmProvider implements LlmProvider {
    ...
    private final OpenAiLlmDriver driver;
    ...
    public List<String> getSupportedModels() {
        try {
            ...
            return Arrays.asList("gpt-4o", "gpt-4o-mini", "gpt-4-turbo", "gpt-3.5-turbo");
        }
    }
    ...
    public List<double[]> embed(String model, List<String> texts) {
        try {
            ...
            request.setModel(model != null ? model : "text-embedding-3-small");
