...
public class SyncResultDTO implements Serializable {
    ...
    public int getUpdatedUsers() { return updatedUsers; }
    public void setUpdatedUsers(int updatedUsers) { this.updatedUsers = updatedUsers; }
    public int getCreatedDepartments() { return createdDepartments; }
    public void setCreatedDepartments(int createdDepartments) { this.createdDepartments = createdDepartments; }
    public int getUpdatedDepartments() { return updatedDepartments; }
    public void setUpdatedDepartments(int updatedDepartments) { this.updatedDepartments = updatedDepartments; }
