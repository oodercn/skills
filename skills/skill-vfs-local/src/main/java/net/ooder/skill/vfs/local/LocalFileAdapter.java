...
public class LocalFileAdapter extends AbstractFileAdapter {

    String lineSeparator = java.security.AccessController.doPrivileged(
            new sun.security.action.GetPropertyAction("line.separator"));

    private static final Log logger = LogFactory.getLog(LocalFileAdapter.class);

    public LocalFileAdapter(String rootPath) {
        super(rootPath);
    }
